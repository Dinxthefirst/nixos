...
Do not use the hardware configurations in this repository as they are likely not compatible with other systems. To generate a new hardware configuration use `nixos-generate-config` 
